...
const Fashon = () => {
  return (
    <section className="pt-[136px] pb-[335px] bg-[#FFF] relative">
        ...
        <div className="absolute left-[565px] top-[-60px] ">
          <Images src={BG1}/>
        </div>
            ...
            <div className="w-[800px] py-[71px] px-[42px] bg-[#FEECC8] rounded-2xl flex absolute bottom-[-220px] left-[517px]">
        ...
        <div className="absolute left-[123px] bottom-[-356px]">
          <Images src={BG2}/>
        </div>
        </Container>
    </section>
